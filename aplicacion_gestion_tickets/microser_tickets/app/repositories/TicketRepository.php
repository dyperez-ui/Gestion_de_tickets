...
class TicketRepository
{
    ...
    public function actividades(Request $request, Response $response, array $args)
    {
        ...
        $actividades = TicketAct::where('ticket_id', $ticketId)
    ...
    public function buscar(Request $request, Response $response)
    {
        ...
        // Si se desde envía admin_id (solo ADMIN lo puede usar)
        ...
        if ($tickets->isEmpty()) {
            return $response->withStatus(204); // vacio
        }
